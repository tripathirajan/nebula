...
- **react-ui-blocks:** redesign ProductCard as a real ecommerce tile ([8865ec7](https://github.com/tripathirajan/nebula/commit/8865ec7))
...
- **react-ui-blocks:** add multi-viewport Responsive story pattern to ProfileHeader ([7d15912](https://github.com/tripathirajan/nebula/commit/7d15912))
- add Mobile Banking composition (header + balance tiles + transactions + BottomNav) ([c198b4c](https://github.com/tripathirajan/nebula/commit/c198b4c))
- colorful stat-card icons in Analytics Overview and Banking Home ([235757c](https://github.com/tripathirajan/nebula/commit/235757c))
...
- **react-ui-blocks:** add PageSection block (layouts) ([c48a99d](https://github.com/tripathirajan/nebula/commit/c48a99d))
- **react-ui-blocks:** add DashboardOverview block, wire marketing/ecommerce/dashboard subpaths ([87ebb4a](https://github.com/tripathirajan/nebula/commit/87ebb4a))
- **react-ui-blocks:** add SignupForm block (authentication/sign-up) ([6007a31](https://github.com/tripathirajan/nebula/commit/6007a31))
- **react-ui-blocks:** add SaasAppHeader stories/tests, wire into root barrel ([dc5b43f](https://github.com/tripathirajan/nebula/commit/dc5b43f))
- react-ui-block ([2f0bf3e](https://github.com/tripathirajan/nebula/commit/2f0bf3e))
...
- **react-ui-blocks:** give the flagship dashboard demo a header and color ([b67e707](https://github.com/tripathirajan/nebula/commit/b67e707))
...
- ProfileHeader/DashboardOverview alignment bugs; feat: colorful stat icons + glass header variant ([873b532](https://github.com/tripathirajan/nebula/commit/873b532))
- error fixes ([d6d940b](https://github.com/tripathirajan/nebula/commit/d6d940b))
- **react-ui-blocks:** remove notification bell's visible outline ([ee0c845](https://github.com/tripathirajan/nebula/commit/ee0c845))
- **react-ui-blocks:** compact SaasAppHeader, move name/role into the menu ([212d21d](https://github.com/tripathirajan/nebula/commit/212d21d))
- **react-ui-blocks:** visual polish from validation feedback ([5f0b20b](https://github.com/tripathirajan/nebula/commit/5f0b20b))
- **react-ui-blocks:** update Storybook titles for the 7 migrated blocks ([031fe01](https://github.com/tripathirajan/nebula/commit/031fe01))
