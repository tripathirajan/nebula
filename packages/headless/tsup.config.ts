...
export default defineConfig((options) => ({
  entry: {
    ...
    'dialog/index': 'src/dialog/dialog/index.ts',
    'alert-dialog/index': 'src/dialog/alert-dialog/index.ts',
    'popover/index': 'src/popover/index.ts',
    'tooltip/index': 'src/tooltip/index.ts',
    'menu/index': 'src/menu/menu/index.ts',
    'dropdown-menu/index': 'src/menu/dropdown-menu/index.ts',
    'context-menu/index': 'src/menu/context-menu/index.ts',
    ...
    'combobox/index': 'src/combobox/combobox/index.ts',
    'autocomplete/index': 'src/combobox/autocomplete/index.ts',
