 ...
 */
type PolymorphicComponentProps<E extends React.ElementType, P = object> = PolymorphicProps<E, P> & Omit<React.ComponentPropsWithoutRef<E>, keyof PolymorphicProps<E, P>>;
/**
 ...
 * ```
 */
type PolymorphicComponentPropsWithRef<E extends React.ElementType, P = object> = PolymorphicComponentProps<E, P> & {
...
type PolymorphicComponent<Default extends React.ElementType, P = object> = {
    <E extends React.ElementType = Default>(props: PolymorphicComponentPropsWithRef<E, P>): React.ReactElement | null;
    displayName?: string;
};
export type { PolymorphicRef, PolymorphicProps, PolymorphicComponentProps, PolymorphicComponentPropsWithRef, PolymorphicComponent, };
