import { ToggleGroup as HeadlessToggleGroup } from '@nebula-lab/headless/toggle-group';
import { cn } from '@nebula-lab/primitives/cn';
import * as React from 'react';

import type { ToggleGroupSingleProps as HeadlessToggleGroupSingleProps } from '@nebula-lab/headless/toggle-group';
 ...
 * (`@nebula-lab/headless`'s `ToggleGroup` with `type="single"` fixed, since a
 ...
 * bordered, gapped buttons. Built directly on `@nebula-lab/headless` rather
