...
import { Tab as StylelessTab } from '@nebula/styleless/tabs';
import * as React from 'react';

import type { TabProps as StylelessTabProps } from '@nebula/styleless/tabs';

type TabProps = StylelessTabProps;

/**
 * Styled wrapper around `@nebula/styleless`'s `Tab` — selection,
