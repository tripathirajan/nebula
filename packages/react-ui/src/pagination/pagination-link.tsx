...
import { PaginationLink as StylelessPaginationLink } from '@nebula/styleless/pagination';
import * as React from 'react';

import type { PaginationLinkProps as StylelessPaginationLinkProps } from '@nebula/styleless/pagination';

type PaginationLinkProps = StylelessPaginationLinkProps;

/**
 * One page number — filled with `--pagination-link-active-bg`/`-active-text`
 * on `data-state="active"` (set by the underlying `@nebula/styleless` link),
